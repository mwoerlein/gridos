...
class ParserBasedTestCase: public TestCase {
    ...
    bool test(const char * input, const char * expectedBinary, const char * expectedPretty = 0, const char * message = 0, size_t start = 0, const char * dumpBinary = 0);
    bool test(String & input, String & expectedBinary, String & expectedPretty, String & message, size_t start = 0, const char * dumpBinary = 0);
